...
export function DocumentDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 3. MAIN INSPECTION AREA (Aligned side-by-side on desktop: ~55% viewer, ~45% record) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        
        {/* LEFT SIDE: Original Document Viewer (~55%) */}
        <div className="lg:col-span-7 bg-white rounded-lg border border-slate-200 overflow-hidden flex flex-col shadow-xs">
