...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-16 bottom-0 left-0 z-40 w-64 bg-slate-900 text-slate-300 border-r border-slate-800
          transition-transform duration-200 ease-in-out lg:translate-x-0 flex flex-col justify-between
